...
namespace DiscordBotCS.HttpResponseTemplates
{
    ...
    public class Ability
    {
        ...
        public Ability2 AbilityDetails { get; set; }
    ...
    public class Move
    {
        ...
        public Move MoveDetails { get; set; }
    ...
    public class Stat
    {
        ...
        public Stat StatDetails { get; set; }
    }
    ...
    public class Type
    {
        ...
        public Type2 TypeDetails { get; set; }
    }
    ...
    public class PokeAPIPokemonResponse
    {
        ...
        public static PokeAPIPokemonResponse GetPokedexData(string json)
        {
            return JsonSerializer.Deserialize<PokeAPIPokemonResponse>(json) ?? new PokeAPIPokemonResponse { };
        }
    }
}
